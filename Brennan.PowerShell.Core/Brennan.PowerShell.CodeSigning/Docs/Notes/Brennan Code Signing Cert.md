# brennan Code Signing Certificate

brennan has purchased a 3rd Party Code-Signing Certificate from DigiCert.
...
The brennan DigiCert Code Signing Certificate is located in:
...
```html
Secret Name :   DigiCert - brennan Code Signing Cert
```
